...
class AboutResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $content[] = [
            'body'        => $this->body1_2,
            'background'  => ($this->image1_2) ? request()->root() . $this->image1_2->url : NULL,
        ...
        $content[] = [
            'body'        => $this->body1_3,
            'background'  => ($this->image1_3) ? request()->root() . $this->image1_3->url : NULL,
        ...
        $content[] = [
            'body'        => $this->body1_4,
            'background'  => ($this->image1_4) ? request()->root() . $this->image1_4->url : NULL,
