...
class TagController extends Controller
{
    ...
    {
        $row = new TagResource(Tag::has('tenant')->findOrFail($id));
    ...
    {
        $data = Tag::has('tenant')->where(['status' => true, 'trash' => false]);
        ...
        return response()->json(['rows' => TagResource::collection($data)], 200);
    }
}
