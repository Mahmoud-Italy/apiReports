...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json([
            ...
            'permissions' => $this->permissions('settings'),
            'rows'        => $rows,
    ...
    {
        $row = Setting::createOrUpdate(NULL, $request->all());
        if($row === true) {
    ...
    {
        $row = new SettingResource(Setting::findOrFail(decrypt($id)));
        return response()->json(['row' => $row], 200);
    }

    public function update(SettingUpdateRequest $request, $id)
    {
        $row = Setting::createOrUpdate(decrypt($id), $request->all());
        if($row === true) {
    ...
    {
        $data = Setting::where(['status' => true, 'trash' => false]);
        ...
        return response()->json(['rows' => SettingResource::collection($data)], 200);
    }
}
