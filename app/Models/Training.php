...
use App\Models\TrainingLanguage;
use App\Models\TrainingQualification;
...
class Training extends Model
{
    ...
    public function courses() {
       return $this->hasMany(TrainingCourse::class, 'training_id')
                   ->select('id','program','institute','duration','date_from','date_to','certificate');
    }
    public function languages() {
       return $this->hasMany(TrainingLanguage::class, 'training_id')
                  ->select('id','language','level');
    }
    public function qualifcations() {
       return $this->hasMany(TrainingQualification::class, 'training_id')
